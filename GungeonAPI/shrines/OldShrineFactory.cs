...
namespace GungeonAPI
{
	...
	public class OldShrineFactory
	{
		...
		public static void Init()
		{
			...
			if (flag)
			{
				Alexandria.DungeonAPI.DungeonHooks.OnFoyerAwake += OldShrineFactory.PlaceBreachShrines;
				Alexandria.DungeonAPI.DungeonHooks.OnPreDungeonGeneration += delegate (LoopDungeonGenerator generator, Dungeon dungeon, DungeonFlow flow, int dungeonSeed)
				{
		...
		public GameObject Build()
		{
			...
			try
			{
				...
				else
				{
					...
					if (flag10)
					{
						this.room = Alexandria.DungeonAPI.RoomFactory.CreateEmptyRoom(12, 12);
					}
		...
		public static void RegisterShrineRoom(GameObject shrine, PrototypeDungeonRoom protoroom, string ID, Vector2 offset, float roomweight)
		{
			...
			Alexandria.DungeonAPI.RoomFactory.RoomData roomData = new Alexandria.DungeonAPI.RoomFactory.RoomData
			{
				room = protoroom,
			...
			Alexandria.DungeonAPI.RoomFactory.rooms.Add(ID, roomData);
			Alexandria.DungeonAPI.DungeonHandler.RegisterForShrine(roomData);
		}
