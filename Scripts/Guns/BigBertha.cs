...
namespace Knives
{
    ...
    public class Big_Bertha : AdvancedGunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            Gun gun = ETGMod.Databases.Items.NewGun("Big Bertha", "Big_Bertha");
            // "kp:basic_gun determines how you spawn in your gun through the console. You can change this command to whatever you want, as long as it follows the "name:itemname" template.
            Game.Items.Rename("outdated_gun_mods:big_bertha", "ski:big_bertha");
            gun.gameObject.AddComponent<Big_Bertha>();
            //These two lines determines the description of your gun, ".SetShortDescription" being the description that appears when you pick up the gun and ".SetLongDescription" being the description in the Ammonomicon entry. 
            gun.SetShortDescription("Bombing Run");
            gun.SetLongDescription("A Big launcher for an even Bigger Lady. \n\nThis burst grenade launcher was designed and weilded by the one and only Big Bertha. A juggernaut of the resistance's fighters. In the frontier wars she would carry out bombing runs from the ground not the sky." +
                "\n\n\n - Knife_to_a_Gunfight");
            ...
            gun.SetupSprite(null, "Big_Bertha_idle_001", 8);
            ...
            gun.DefaultModule.burstCooldownTime = .17f;
            ...
            gun.carryPixelOffset = new IntVector2(9, -3);
            gun.shellCasing = BreakableAPIToolbox.GenerateDebrisObject("Knives/Resources/Casings/Big_Bertha_mag.png", true, 2, 4, 200, 150, null, 3f, null, null, 1).gameObject;
