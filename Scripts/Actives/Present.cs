...
namespace Knives
{
    class Present : SpawnObjectPlayerItem
    {
        public static void Init()
        {
            ...
            string longDesc = "50-50 chance to be really good or kinda bad\n\n" +
                "" +
                "It's the random employee evaluation day in the gungeon and Kaliber has wrapped gifts for her subjects. Lets help her distrubute them.  :)" +
