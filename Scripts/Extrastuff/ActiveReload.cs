...
namespace Knives
{
            ...
            int pixelWidth)
        {
            ...
            if (attachParent != null && attachParent.CurrentGun != null && attachParent.CurrentGun.GetComponent<MultiActiveReloadController>() != null)
            {
                foreach (MultiActiveReloadData data in attachParent.CurrentGun.GetComponent<MultiActiveReloadController>().reloads)
                {
                    ...
                    sprite.Width = width2 * data.BarWidth;
                    sprite.Height = width2 * data.BarHeight;
    ...
    {
        public MultiActiveReloadData(float activeReloadStartPercentage, int startValue, int endValue, int pixelWidth, int activeReloadLastTime, bool stopsReload, bool canAttemptActiveReloadAfterwards, ActiveReloadData reloadData, bool usesActiveReloadData, string Name, float barheight, float barwidth)
        {
