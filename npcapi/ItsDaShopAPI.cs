...
namespace NpcApi
{
    static class ItsDaFuckinShopApi
    {
        ...
        public static tk2dSpriteAnimationClip hexclip = null;
        /// <summary>
        ...
        /// 
        /// <param name="hexSpritePaths"></param> 
        /// <param name="hexFps"></param> 
        /// 
        ...
        public static GameObject SetUpShop(string name, string prefix, List<string> idleSpritePaths, int idleFps, List<string> talkSpritePaths, int talkFps, GenericLootTable lootTable, CustomShopItemController.ShopCurrencyType currency, string runBasedMultilineGenericStringKey,
            string runBasedMultilineStopperStringKey, string purchaseItemStringKey, string purchaseItemFailedStringKey, string introStringKey, string attackedStringKey, string stolenFromStringKey, Vector3 talkPointOffset, Vector3[] itemPositions = null, float costModifier = 1, bool giveStatsOnPurchase = false,
            ...
            string minimapIconSpritePath = "", bool addToMainNpcPool = false, float percentChanceForMainPool = 0.1f, DungeonPrerequisite[] prerequisites = null, List<string> hexSpritePaths = null, int hexFps = 8)
        {
            ...
            try
            {
                ...
                var hexIdsList = new List<int>();
                foreach (string sprite in hexSpritePaths)
                {
                    hexIdsList.Add(SpriteBuilder.AddSpriteToCollection(sprite, collection));
                    
                }
                NPCAPISpriteBuilder.AddAnimation(spriteAnimator, collection, hexIdsList, "StealHex", tk2dSpriteAnimationClip.WrapMode.Once, 15);
                ...
                if (!string.IsNullOrEmpty(currencyIconPath))
                {
                    ...
                    //ETGModConsole.Log("Added Custom Currency type");
                }
                else
                {
                    //ETGModConsole.Log("Failed Currency Type");
